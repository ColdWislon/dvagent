...
| `template/uvm-gen/` | the environment generator CLI (Python + Jinja2; own README, examples, 35-test suite). Also usable standalone — every generated env carries its own `.github/` Copilot kit |
